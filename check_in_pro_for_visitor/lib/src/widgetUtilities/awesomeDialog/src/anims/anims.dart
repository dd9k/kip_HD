...
class FadeIn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final newTween = MultiTween<AniProps>()
      ...
      ..add(AniProps.translateX, Tween(begin: 60.0, end: 0.0), Duration(milliseconds: 500), curve);
...
class ShowHide extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomAnimation<MultiTweenValues<AniProps>>(
      delay: Duration(milliseconds: (200 * delay).round()),
      control: isShow ? CustomAnimationControl.PLAY : CustomAnimationControl.PLAY_REVERSE,
      duration: tween.duration,
      tween: tween,
      child: child,
