...
part 'ApiServiceBackup.chopper.dart';

// final $url = '${Constants.URL_LIST[Constants().indexURL]}${path}';
@ChopperApi(baseUrl: "")
abstract class ApiServiceBackup extends ChopperService {
  ...
  static ApiServiceBackup create() {
    ...
    return _$ApiServiceBackup(client);
  }

  static ApiServiceBackup createOCR() {
    HttpClient httpclient = new HttpClient()
      ..badCertificateCallback = ((X509Certificate cert, String host, int port) => true);
    httpclient.connectionTimeout = Constants.CONNECTION_TIME_OUT_OCR;
    var ioClient = new IOClient(httpclient);
    final client = ChopperClient(
      baseUrl: Constants.URL_BACKUP,
      services: [
        _$ApiServiceBackup(),
      ],
      client: ioClient,
